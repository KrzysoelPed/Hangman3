...
public class MainActivity extends AppCompatActivity {
    ...
    {
        Toast toast = Toast.makeText(getApplicationContext(),"Gratulacje, odgadłeś słowo ! \n \n Aby rozpocząć nową grę, kliknij klawisz ze znakiem zapytania :)",Toast.LENGTH_LONG);
        toast.setGravity(Gravity.CENTER_VERTICAL|Gravity.CENTER,0,0);
